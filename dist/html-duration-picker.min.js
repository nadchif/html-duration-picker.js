 ...
 * @license Apache-2.0
 *
 */e.default=function(){const t=({target:{selectionStart:t,value:e}},r)=>{const n=e.indexOf(":"),a=e.lastIndexOf(":");let o;return t<n&&(o="hours"),t>n&&(r||t-1<a)&&(o="minutes"),!r&&t>a&&(o="seconds"),{cursorSelection:o,hideSeconds:r,hourMarker:n,minuteMarker:a}},e=e=>{const n=r(e.target),{cursorSelection:a,hourMarker:o,minuteMarker:i}=t(e,n);if(a){if("hours"===a)return e.target.setAttribute("data-adjustment-mode",3600),void e.target.setSelectionRange(0,o);if("minutes"===a){const t=n?3:0;return e.target.setAttribute("data-adjustment-mode",60),void e.target.setSelectionRange(o+1,i+t)}if("seconds"===a)return e.target.setAttribute("data-adjustment-mode",1),void e.target.setSelectionRange(i+1,i+3);e.target.setAttribute("data-adjustment-mode","ss"),e.target.setSelectionRange(i+1,i+3)}},r=t=>void 0!==t.dataset.hideSeconds&&"false"!==t.dataset.hideSeconds,n=(t,e)=>{const n=Math.floor(e/3600);e%=3600;const a=Math.floor(e/60),o=e%60,i=String(n).padStart(2,"0"),s=String(a).padStart(2,"0"),d=String(o).padStart(2,"0"),u=`${i}:${s}`;t.value=r(t)?u:`${u}:${d}`,t.dispatchEvent(((t,e={bubbles:!1,cancelable:!1})=>{if("function"==typeof Event)return new Event(t);{const r=document.createEvent("Event");return r.initEvent(t,e.bubbles,e.cancelable),r}})("input"))},a=(t,e)=>{const n=t.value.indexOf(":"),a=t.value.lastIndexOf(":"),o=r(t);return t.focus(),t.select(),e>=3600?(t.selectionStart=0,void(t.selectionEnd=n)):e>=60&&!o?(t.selectionStart=n+1,void(t.selectionEnd=a)):(t.selectionStart=a+1,void(t.selectionEnd=a+3))},o=t=>{let e=1;return Number(t.getAttribute("data-adjustment-mode"))>0&&(e=Number(t.getAttribute("data-adjustment-mode"))),e},i=(t,e)=>{const r=o(t);let i=l(t.value);switch(e){case"up":i+=r;break;case"down":i-=r,i<0&&(i=0)}const s=u(t,i);n(t,s),a(t,r)},s=(t,e)=>{const r=o(t);switch(e){case"left":a(t,60*r);break;case"right":a(t,r/60)}},d=(t,e)=>{return RegExp(e?"^[0-9][0-9]:[0-5][0-9]$":"^[0-9][0-9]:[0-5][0-9]:[0-5][0-9]$").test(t)},u=(t,e)=>{const{maxDuration:r,minDuration:n}=b(t);return Math.min(Math.max(e,n),r)},l=t=>{const e=t.split(":");return e.length<2?0:Number(e[2]||0)+Number(60*e[1])+Number(60*e[0]*60)},c=e=>{const n=r(e.target),{cursorSelection:a}=t(e,n),o=e.target.value.split(":");e.target.dataset.duration&&d(e.target.dataset.duration,n)&&(n&&2!==o.length||!n&&3!==o.length)?e.target.value=e.target.dataset.duration:n||3===o.length?n&&2!==o.length?e.target.value="00:00":(isNaN(o[0])&&(o[0]="00"),(isNaN(o[1])||o[1]<0)&&(o[1]="00"),(o[1]>59||o[1].length>2)&&(o[1]="59"),2===o[1].length&&o[1].slice(-1)===e.key&&"minutes"===a&&s(e.target,"right"),n||((isNaN(o[2])||o[2]<0)&&(o[2]="00"),(o[2]>59||o[2].length>2)&&(o[2]="59")),e.target.value=o.join(":")):e.target.value="00:00:00"},p=t=>{const e=t.target,r=e.value||e.dataset.duration,a=l(r);n(e,u(e,a))},g=t=>{if(["ArrowDown","ArrowUp","ArrowLeft","ArrowRight","Enter"].includes(t.key)){switch(t.key){case"ArrowDown":i(t.target,"down");break;case"ArrowUp":i(t.target,"up");break;case"ArrowLeft":s(t.target,"left");break;case"ArrowRight":s(t.target,"right");break;case"Enter":p(t),t.target.blur()}t.preventDefault()}if(isNaN(t.key)&&!["Backspace","ArrowDown","ArrowUp","Tab"].includes(t.key))return t.preventDefault(),!1},f=(t,e,n)=>{const a=t.dataset[e];return d(a,r(t))?l(a):n},b=t=>{return{minDuration:f(t,"durationMin",0),maxDuration:f(t,"durationMax",1/0)}},m=()=>{return document.querySelectorAll("input.html-duration-picker").forEach(t=>{if("true"==t.getAttribute("data-upgraded"))return;const a=t.currentStyle||window.getComputedStyle(t),o=a.marginRight,s=a.marginLeft,b=a.width;t.setAttribute("data-upgraded",!0),n(t,(t=>{let e=f(t,"duration",0);return 0===e&&t.value&&d(t.value,r(t))&&(e=l(t.value)),u(t,e)})(t)),t.style.textAlign="right",t.style.paddingRight="20px",t.style.boxSizing="border-box",t.style.width="100%",t.style.margin=0,t.style.cursor="text",t.setAttribute("aria-label","Duration Picker"),t.addEventListener("keydown",g),t.addEventListener("select",e),t.addEventListener("mouseup",e),t.addEventListener("change",c),t.addEventListener("blur",p),t.addEventListener("keyup",c),t.addEventListener("drop",t=>t.preventDefault());const m=document.createElement("button"),h=document.createElement("button"),v=[m,h];m.setAttribute("aria-label","Increase duration"),m.setAttribute("style",`text-align:center; width: 16px;padding: 0px 4px; border:none; cursor:default;\n        height:${t.offsetHeight/2-1}px !important; position:absolute; top: 1px;`),m.classList.add("scroll-up"),h.setAttribute("aria-label","Decrease duration"),h.setAttribute("style",`text-align:center; width: 16px;padding: 0px 4px; border:none; cursor:default;\n        height:${t.offsetHeight/2-1}px !important; position:absolute; top: ${t.offsetHeight/2-1}px;`),h.classList.add("scroll-down");const x=document.createElement("div"),y=document.createElement("div");x.setAttribute("style","width:0;height:0;\n        border-style:solid;border-width:0 4px 5px 4px; border-color:transparent transparent #000 transparent"),y.setAttribute("style","width:0;height:0;\n        border-style:solid;border-width:5px 4px 0 4px; border-color:#000 transparent transparent transparent"),h.appendChild(y),m.appendChild(x),v.forEach(e=>{let r;e.addEventListener("mousedown",n=>{n.target.style.transform="translateY(1px)",n.preventDefault(),e==m?(i(t,"up"),r=setInterval(i,200,t,"up")):(i(t,"down"),r=setInterval(i,200,t,"down"))}),e.addEventListener("mouseup",t=>{t.target.style.transform="translateY(0)",clearInterval(r)}),e.addEventListener("mouseleave",t=>{t.target.style.transform="translateY(0)",clearInterval(r)})});const w=document.createElement("div");w.setAttribute("style",`display:inline-block; position: absolute;top:1px;left: ${parseFloat(b)-20}px;\n        height:${t.offsetHeight}px; padding:2px 0`),w.classList.add("controls"),w.appendChild(m),w.appendChild(h);const E=document.createElement("div");E.setAttribute("style",`display: inline-block; position: relative; background: transparent;\n        padding: 0px; width: ${b}; margin-left: ${s}; margin-right: ${o};`),E.classList.add("html-duration-picker-wrapper"),t.parentNode.insertBefore(E,t),E.appendChild(t),E.appendChild(w)}),!0};return window.addEventListener("DOMContentLoaded",()=>m()),{init:m,refresh:m}}()}]).default}));